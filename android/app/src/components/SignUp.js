...
import login from '../img/start.png';
      ...
      <View style={styles.container}>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.input}>
            <Image source={user} style={styles.icons}></Image>
            <TextInput
              // style={styles.input}
              color={'#0000'}
          ...
          <View style={styles.input}>
            <Image source={mark} style={styles.icons}></Image>
            <TextInput
              // style={styles.input}
              color={'#0000'}
          ...
          <View style={styles.input}>
            <Image source={mail} style={styles.icons}></Image>
            <TextInput
              // style={styles.input}
              color={'#0000'}
          ...
          <View style={styles.input}>
            <Image source={phone} style={styles.icons}></Image>
            <TextInput
              // style={styles.input}
              color={'#0000'}
          ...
          <View style={styles.input}>
            <Image source={location} style={styles.icons}></Image>
            <TextInput
              // style={styles.input}
              color={'#0000'}
          ...
          <View style={{width: wp('80%'), alignSelf:'center',marginTop:hp("1%")}}>
            <Text style={styles.label2}>
              By signing up, you're agree to our <Text style={{color:"#F4BD2F",fontSize: 14,
    fontFamily: 'Roboto',}}>Terms & Conditions</Text> and <Text style={{color:"#F4BD2F",fontSize: 14,
    fontFamily: 'Roboto',}}>Privacy
              Policy</Text>.
            </Text>
          </View>
