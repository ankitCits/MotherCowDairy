  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.form}>
       ...
       <View style={styles.input}>
       <PasswordL name="lock" size={20} color="#7A869A" style={styles.icons1} />
       <TextInput
        ...
        <Pressable  style={styles.pressable}>
          <Text style={{textAlign:'center',justifyContent:'center',alignItems:'center',alignContent:'center'}}>Login</Text>
        </Pressable>
